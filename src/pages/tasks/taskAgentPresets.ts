export const UNITY_TASK_AGENT_PRESETS = [
  {
    ...
    defaultSummary: "플레이어 목표, 작업 범위, 핵심 메커닉 의도와 기능 명세를 정리하고 있습니다.",
    defaultInstruction: "집중할 점: 대상 Unity 기능, 플레이어 목표, 범위, 제약 조건, 기능 명세와 open question을 한국어로 명확히 정리하세요.",
    discussionLine: "GAME DESIGNER: 기능 목표, 플레이 판타지, 구현 범위와 기능 명세를 한국어로 정리하고 있습니다.",
  ...
  },
  {
    ...
    defaultSummary: "레벨 흐름, 전투 템포, 공간 연출, 플레이 동선을 정리하고 있습니다.",
    defaultInstruction: "집중할 점: 씬 흐름, 전투 템포, 레벨별 설계 메모, encounter와 pacing 문제를 한국어로 정리하세요.",
    discussionLine: "LEVEL DESIGNER: 씬 흐름, 템포, 동선, 전투 가독성을 한국어로 정리하고 있습니다.",
  ...
  },
  {
    ...
    defaultSummary: "아트 파이프라인, 셰이더, 프리팹, VFX, 에셋 연결 제약을 확인하고 있습니다.",
    defaultInstruction: "집중할 점: Unity 통합을 위한 프리팹, 셰이더, VFX, 렌더링, 콘텐츠 연결 제약과 시각 품질 리스크를 한국어로 검토하세요.",
    discussionLine: "TECHNICAL ARTIST: 에셋 연결, 프리팹 안전성, 셰이더/VFX 제약을 한국어로 점검하고 있습니다.",
